  ...
  <div class="calendar">
    ...
    <div class="border-right">
      ...
      <div class="row col bg border-bottom">
        <div class="now-center">{{ I18n.getMessage('my.jieQi') }}{{ state.prevJq }}</div>
      </div>
    ...
    <div class="center border-right bg">
      <div class="border-bottom">
        ...
        <div>
          <div class="now-center">{{ I18n.getMessage('label.gongLi') }} {{ state.year }}{{ I18n.getMessage('label.nian') }} {{ state.month }}{{ I18n.getMessage('label.yue') }} {{ state.day }}{{ I18n.getMessage('label.ri') }} {{ I18n.getMessage('my.week') }}{{ state.weekInChinese }} {{ state.xingZuo }}{{ I18n.getMessage('my.xingZuo') }}
          </div>
          <div class="today">
          ...
          <div class="now-center lunar">{{ I18n.getMessage('label.nongLi') }} {{ state.lunarYearInChinese }}{{ I18n.getMessage('label.nian') }} {{ state.lunarMonthInChinese }}{{ I18n.getMessage('label.yue') }} {{ state.lunarDayInChinese }}</div>
        </div>
      </div>
    ...
    <div>
      ...
      <div class="row col bg border-bottom">
        <div class="now-center">{{ I18n.getMessage('my.jieQi') }}{{ state.nextJq }}</div>
      </div>
      <div class="yj-container border-bottom">
