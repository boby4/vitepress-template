<template>
  <swiper
    ...
    :modules="[Autoplay]"
  >
    <swiper-slide v-for="(item, index) in skills" :key="index" class="swiper-slide">
...
const skills = ref(['sass', 'JavaScript', 'CSS', 'HTML', 'Iconfont', 'webpack', 'Vue', 'Nodejs', 'typescript', 'a-adobeillustrator', 'a-adobephotoshop', 'Docker']); // 技能列表
